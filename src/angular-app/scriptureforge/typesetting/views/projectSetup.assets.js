...
angular.module('typesetting.projectSetupAssets',
['jsonRpc', 'ui.bootstrap', 'bellows.services', 'ngAnimate',
    'palaso.ui.notice', 'typesetting.services', 'angularFileUpload',
    'palaso.ui.mockUpload'])
.controller('projectSetupAssetsCtrl',
  [
      '$scope',
      '$state',
      '$upload',
      'typesettingAssetService',
      'typesettingEditService' ,
      'sessionService',
      'modalService',
      'silNoticeService',
...
$scope.deleteFile = function deleteFile(assets, index) {
  ...
  function setProjectConfig(){
    typesettingEditService.setProjectConfig($scope.usfmcode,$scope.cidlist)
  }
$scope.usfmcode = "";
    $scope.cidlist = "";
// For the buttons.
